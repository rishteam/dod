...
//            auto boundSize = std::min(bound.getScale().x,bound.getScale().y)*0.1;
                ...
                switch( m_gizmoMode ) {
                    ...
                    case Gizmo::RotationMode :{
                        ...
                        Renderer2D::DrawLine(bound.getPosition(), glm::vec3(bound.getPosition(),0.f)+glm::vec3(tmpPoint.x*cosR-tmpPoint.y*sinR, tmpPoint.x*sinR+tmpPoint.y*cosR, 0.f), glm::vec4(1.f, 0.f, 0.f, 1.f));
