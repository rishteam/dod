            ...
            if(emitter.vortexSensitive) {
                ...
                if (emitter.vortexType == STATIC_VORTEX) {
                    ...
                    for(auto &vortex : emitter.static_vortexes) {
                        ...
                        ImGui::PushItemWidth(250);
                        ImGui::DragFloat2("Distance##Vortex", glm::value_ptr(vortex.pos), 0.1f, 0.f, 0.f, "%.1f");
                        ImGui::DragFloat2("Turbulence##Vortex", glm::value_ptr(vortex.turbulence), 0.1f, 0.f, 0.f, "%.1f");
                        ImGui::DragFloat("Size", &vortex.currentSize, 0.1f, 0.f, 0.f, "%.2f");

                        ImGui::Checkbox("Draw vortex##Vortex", &vortex.draw);
                    ...
                    ImGui::DragScalar("Emit Per Sec", ImGuiDataType_U32, &emitter.vortexEmitNumber, 1.f, &emitMin, &emitMax, "%d");
