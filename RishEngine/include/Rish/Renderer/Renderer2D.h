...
public:
    ...
    static void DrawTriangle(const glm::vec2& position, const glm::vec2& size, const Ref<Texture2D> &texture);
    static void DrawTriangle(const glm::vec3& position, const glm::vec2& size, const Ref<Texture2D> &texture);
    static void DrawTriangle(const glm::vec2& position, const glm::vec2& size, const Ref<Texture2D> &texture, const glm::vec4 &color);
    static void DrawTriangle(const glm::vec3& position, const glm::vec2& size, const Ref<Texture2D> &texture, const glm::vec4& color);
